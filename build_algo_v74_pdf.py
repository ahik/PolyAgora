"""
Render Algo_V74.md to a single-file PDF with a per-page "Confidential &
Proprietary" footer and page numbers.

Stack: python-markdown (with `tables`, `fenced_code`, `codehilite`) → HTML
→ WeasyPrint → PDF. WeasyPrint's CSS @page rules handle the per-page
footer in a standards-compliant way.
"""
...
SRC = ROOT / "Algo_V74.md"
DST = ROOT / "Algo_V74.pdf"
...
@page {
    ...
    @bottom-center {
        content: "PolyAgora V7.4 — Algorithm and Methods";
        font-family: "DejaVu Sans", "Helvetica", sans-serif;
        font-size: 7.5pt;
        color: #777;
    }
...
<html><head><meta charset=\"utf-8\"><title>PolyAgora V7.4 — Algorithm and Methods</title></head>

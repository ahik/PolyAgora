"""
Render V76_Findings.md → V76_Findings.pdf with a per-page footer.

Same CSS stack and pipeline as `build_v74d_vs_momentum_pdf.py`, retitled
for the V7.6 first-cut findings report.
"""
...
SRC = ROOT / "V76_Findings.md"
DST = ROOT / "V76_Findings.pdf"
...
@page {
    ...
    @bottom-center {
        content: "PolyAgora V7.6 — First-Cut Findings";
        font-family: "DejaVu Sans", "Helvetica", sans-serif;
        font-size: 7.5pt;
        color: #777;
    }
...
<html><head><meta charset=\"utf-8\"><title>PolyAgora V7.6 — First-Cut Findings</title></head>
